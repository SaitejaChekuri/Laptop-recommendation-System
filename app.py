...
# Ensure SSL certificate verification uses certifi's certificate bundle
os.environ['REQUESTS_CA_BUNDLE'] = certifi.where()

# Set up logging
logging.basicConfig(level=logging.INFO)

openai.api_key = open(r"C:\Users\sahith\Desktop\PROJECTS\Laprec\ShopAssistAI\OpenAI_API_Key.txt", "r").read().strip()

app = Flask(__name__)

conversation_bot = []
conversation = initialize_conversation()
introduction = get_chat_model_completions(conversation, model='gpt-3.5-turbo-16k')
...
def invite():
    ...
    if top_3_laptops is None:
        ...
        response_assistant = get_chat_model_completions(conversation, model='gpt-3.5-turbo-16k')
        ...
        if "No" in confirmation:
            ...
            recommendation = get_chat_model_completions(conversation_reco, model='gpt-3.5-turbo-16k')
        ...
        response_asst_reco = get_chat_model_completions(conversation_reco, model='gpt-3.5-turbo-16k')
